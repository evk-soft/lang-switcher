...
**Статус на 2026-09-07:** M1 (Windows MVP) в работе, реализованы задачи 1–10. Готовы ядро, конфиг, порты, инфраструктура Windows-потоков, DPI-манифест и layered-оверлей с ручным smoke-примером. **Основной бинарник пока только проверяет DPI-awareness и завершает работу**: отслеживание раскладки и курсора, трей, звук, автозапуск и общий рантайм ещё предстоит реализовать. Порядок продолжения — в [плане M1](docs/superpowers/plans/2026-07-03-m1-windows-mvp.md), проверенные исправления и ограничения — в [аудите](docs/research/2026-09-07-implementation-audit.md).
