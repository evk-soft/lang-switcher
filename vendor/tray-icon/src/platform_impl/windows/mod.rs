    ...
    pub fn new(id: TrayIconId, attrs: TrayIconAttributes) -> crate::Result<Self> {
        ...
        unsafe {
            ...
            let traydata = TrayUserData {
                ...
                hover_tracking: attrs.hover_tracking,
                visible: true,
            };
...
unsafe extern "system" fn tray_proc(
    ...
    match msg {
        ...
        {
            // The application can opt out of unused hover events and their timer (ADR-0017).
            if lparam as u32 == WM_MOUSEMOVE && !userdata.hover_tracking {
                return 0;
            }
