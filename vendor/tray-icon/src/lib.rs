...
pub struct TrayIconAttributes {
    ...
    /// Track Enter/Move/Leave and their native timer. Defaults to true. Windows only.
...
impl TrayIconBuilder {
    ...
    /// Disable unused hover events and their timer without disabling clicks or menus.
    /// Defaults to true. Windows only; set before creating the native window.
    #[cfg(target_os = "windows")]
    pub fn with_hover_tracking(mut self, enable: bool) -> Self {
        self.attrs.hover_tracking = enable;
        self
    }
